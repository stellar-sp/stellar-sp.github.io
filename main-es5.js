                ...
                AppComponent.prototype.ngOnInit = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.http.get(this.configUrl).toPromise()];
                                case 1:
                                    conf = _a.sent();
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        smartAccountCreatorKeyPair = stellar_sdk_dist_stellar_sdk__WEBPACK_IMPORTED_MODULE_2__["Keypair"].fromSecret(self.smartAccountCreatorSeed);
                                    ...
                                    case 3:
                                        fee = _b.sent();
                                        createSmartAccountTransaction = new stellar_sdk_dist_stellar_sdk__WEBPACK_IMPORTED_MODULE_2__["TransactionBuilder"](self.smartAccountCreator, { fee: fee, networkPassphrase: self.networkPassphrase })
                ...
                AppComponent.prototype.signAndSubmit = function (self, ops) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    smartAccountKeyPair = stellar_sdk_dist_stellar_sdk__WEBPACK_IMPORTED_MODULE_2__["Keypair"].fromSecret(self.smartAccountPrivateKey);
                                ...
                                case 2:
                                    fee = _b.sent();
                                    txBuilder = new stellar_sdk_dist_stellar_sdk__WEBPACK_IMPORTED_MODULE_2__["TransactionBuilder"](smartAccount, { fee: fee, networkPassphrase: self.networkPassphrase })
                                        .setTimeout(0);
                                    try {
