...
let AppComponent = class AppComponent {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const source = Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["interval"])(10000);
        ...
        (function main() {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                try {
                    ...
                    var smartAccountCreatorKeyPair = stellar_sdk__WEBPACK_IMPORTED_MODULE_2__["Keypair"].fromSecret(self.smartAccountCreatorSeed);
                    ...
                    const createSmartAccountTransaction = new stellar_sdk__WEBPACK_IMPORTED_MODULE_2__["TransactionBuilder"](self.smartAccountCreator, { fee: fee, networkPassphrase: self.networkPassphrase })
    ...
    signAndSubmit(self, ops) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            var smartAccountKeyPair = stellar_sdk__WEBPACK_IMPORTED_MODULE_2__["Keypair"].fromSecret(self.smartAccountPrivateKey);
            const smartAccount = yield self.server.loadAccount(smartAccountKeyPair.publicKey());
            const fee = yield self.server.fetchBaseFee();
            var txBuilder = new stellar_sdk__WEBPACK_IMPORTED_MODULE_2__["TransactionBuilder"](smartAccount, { fee: fee, networkPassphrase: self.networkPassphrase })
                .setTimeout(0);
            for (let op of ops) {
